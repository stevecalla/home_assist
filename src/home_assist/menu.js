...
const SECTIONS = [
  ...
  { label: 'RADIO — listen to it yourself', color: BLUE, items: [
    ...
    { label: 'Listen — FM radio 98.5 (audio)', desc: 'rtl_fm, not rtl_433. Plays on THIS machine\'s speakers. The most convincing proof the dongle works — you can hear it', bin: 'node', args: [AUDIO, 'fm', '98.5'], cli: 'node ' + AUDIO + ' fm 98.5' },
    { label: 'Listen — AM / airband 124.0 (audio)', desc: 'Narrowband AM. Aviation, not AM broadcast — 530-1700 kHz is below what this tuner can reach', bin: 'node', args: [AUDIO, 'am', '124.0'], cli: 'node ' + AUDIO + ' am 124.0' },
    { label: 'Listen — NOAA weather radio', desc: 'Continuous voice forecast on 162.550. A real broadcast, not a data feed — and it works when the internet does not', bin: 'node', args: [AUDIO, 'weather'], cli: 'node ' + AUDIO + ' weather' },
