...
const SECTIONS = [
  ...
  { label: 'RADIO — listen to it yourself', color: BLUE, items: [
    ...
    { label: 'Hopping endpoints — hop the WHOLE band', desc: 'THE test for 282/290. Same 13-hop sweep with the extra decoders on. Ctrl-C prints every endpoint heard by protocol and frequency. Run several full passes before calling it empty', bin: 'node', args: [LISTEN, 'hopsweep'], cli: 'node ' + LISTEN + ' hopsweep' },
